...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      { ";b", Util.pick("buffers"), desc = "Buffers" },
      ...
      -- stylua: ignore
      { ";F", Util.pick("files", { find_command = { "fd" }, cwd = vim.uv.cwd(), hidden = true }), desc = "Find Files (cwd)" },
      { ";r", Util.pick("oldfiles"), desc = "Recent" },
      { ";R", Util.pick("oldfiles", { cwd = vim.uv.cwd() }), desc = "Recent (cwd)" },
      { ";E", Util.pick("diagnostics", { buf = 0 }), desc = "Document diagnostics" },
      { ";e", Util.pick("diagnostics"), desc = "Workspace diagnostics" },
      { ";W", Util.pick("live_grep", { cwd = vim.uv.cwd(), hidden = true }), desc = "Grep (cwd)" },
